...
def Simulate_Clusters():
  ...
  p2 = int(input('Enter the upper bound for points.......'))
    ...
    # This is passing static data using hard coded arrays
    height=[5.1,5.3,5.5,5.7,5.9,6.1,6.3,6.5]
    width=[20,24,28,32,36,40,44,48]

    X = init_graph(len(height), height, width)
    plt.scatter(X[:, 0], X[:, 1])
    plt.show()
